...
namespace Microsoft.Samples.Kinect.VisualizadorMultimodal.db
{
    public class BackupDataContext : DbContext
    {
        ...
        public DbSet<RelationInterval> RelationInterval { get; set; }
        public DbSet<RelationInterval> IntervalGroup { get; set; }
        ...
        public Scene LoadScene()
        {
            ...
            return Scene
                ...
                .Include(s => s.Interaction.IntervalGroups)
                .Include(s => s.Interaction.RelationIntervals)
                .ToList()[0];
        }
